...
def test_deepseek_v32_context_forward():
    ...
    with torch.random.fork_rng(devices=[torch.cuda.current_device()]):
        ...
        torch.testing.assert_close(
            ...
            rtol=2e-2,
            atol=2e-3,
            msg="Repeated token-ID forwards with fresh caches differ",
        )
        with fresh_metadata(32) as metadata:
        ...
        torch.testing.assert_close(
            ...
            rtol=2e-2,
            atol=2e-3,
            msg="Token-ID and embedding-input logits differ",
        )
        ...
        torch.testing.assert_close(
            ...
            rtol=2e-2,
            atol=2e-3,
            msg="Causal-prefix logits differ from full-context logits",
        )
